...
众所周知广泛应用于需要极致 C++ 性能的场景，但是它的安全性问题也一直被人诟病。这个问题并非没人想解决。这些年来我用过 Valgrind、gperftools、Sanitizers、`_GLIBCXX_DEBUG`、`strcpy_s`、FORTIFY、各种代码检查工具，也确实被它们救过。但是 C++ 的安全问题依然没有彻底解决，并且还在发展之中，本文就从头盘点一下 C++ 内存安全技术的发展历史。
