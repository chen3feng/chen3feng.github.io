...
- [**nuthatch**](/nuthatch/) *(self-built)* — a from-scratch streaming MoE inference engine I wrote to test whether a **usage-learned** expert cache beats naive LRU / OS caching (it does — and cross-architecture). [源码分析（11 章）](/nuthatch/) · [仓库](https://github.com/chen3feng/nuthatch)。
